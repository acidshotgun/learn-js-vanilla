...
- [x] Если `this` используется вне методов объекта или в глобальной области видимости, то по умолчанию `this` ссылается на `глобальный объект (Window в браузере, Global в Node.js)`.
