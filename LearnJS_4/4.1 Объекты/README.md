...
```
  ...
  ![image](https://github.com/acidshotgun/learn-js-vanilla/assets/117285472/daa42f2d-ae61-4cf1-86bd-c5ededbdc777)
...
- [x] Объекты –  хранят свойства (пары ключ-значение), где:
...
- [x] Чтобы получить доступ к свойству, мы можем использовать:
